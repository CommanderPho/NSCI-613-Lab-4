...
\slntParagraph{The effect of increasing gM on spiking frequency can be observed in Figure \ref{Fig:2a2}. Within a given burst size (number of spikes per burst) the spike frequency decreases monotonically for increasing values of gM. A sharp deviation from this pattern can be observed at values where the number of spikes per burst transitions to a higher number, such as $gM = 0.5$, and $gM = 0.7$. Consistent with our prior interpretation, spiking disappears entirely for $gM >= 1.3$.}

\subQuestion{Interaction of Ionic Currents}

\slntParagraph{Within the observed region, the M-type K+ current was the primary determinant of the spiking frequency for the membrane voltage. A strong overall trend was observed where increasing $gM$ resulted in a decrease in firing frequency.}
...
\hline                       
0.060 & Last single spiking regime & 10.381 \\            
\hline                       
0.070 & full pair spiking & 9.275 \\             
\hline                       
0.140 & full triple spiking & 53.171 \\            
\hline                       
0.200 & full quadruple spiking & 73.125 \\            
\hline                       
\end{tabular}                
...
\slntParagraph{The gNaP values where the number of spikes per burst change are listed in Table \ref{table:3}.}
